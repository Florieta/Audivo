        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    Narrator = table.Column<string>(type: "nvarchar(300)", maxLength: 300, nullable: true),
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        ...
                        onDelete: ReferentialAction.Cascade);
                    table.ForeignKey(
                        name: "FK_UserLibraries_Audiobooks_AudiobookId",
                        column: x => x.AudiobookId,
                        principalTable: "Audiobooks",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Cascade);
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    PositionInChapter = table.Column<TimeSpan>(type: "time", nullable: false),
                ...
                constraints: table =>
                {
                    table.PrimaryKey("PK_ListeningProgressRecords", x => x.Id);
                    table.ForeignKey(
                        name: "FK_ListeningProgressRecords_AspNetUsers_UserId",
                        column: x => x.UserId,
                        principalTable: "AspNetUsers",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Cascade);
                    table.ForeignKey(
                        name: "FK_ListeningProgressRecords_Audiobooks_AudiobookId",
                        column: x => x.AudiobookId,
                        principalTable: "Audiobooks",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Restrict);
                    table.ForeignKey(
                        name: "FK_ListeningProgressRecords_Chapters_CurrentChapterId",
            ...
            migrationBuilder.CreateIndex(
                name: "IX_ListeningProgressRecords_AudiobookId",
                table: "ListeningProgressRecords",
                column: "AudiobookId");

            migrationBuilder.CreateIndex(
                name: "IX_ListeningProgressRecords_CurrentChapterId",
                table: "ListeningProgressRecords",
                column: "CurrentChapterId");

            migrationBuilder.CreateIndex(
                name: "IX_ListeningProgressRecords_UserId_AudiobookId",
                table: "ListeningProgressRecords",
            ...
            migrationBuilder.CreateIndex(
                name: "IX_UserLibraries_AudiobookId",
                table: "UserLibraries",
                column: "AudiobookId");

            migrationBuilder.CreateIndex(
                name: "IX_UserLibraries_UserId_AudiobookId",
                table: "UserLibraries",
                columns: new[] { "UserId", "AudiobookId" },
                unique: true);
        }
